          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-brand-maroon mb-2">{plan.name}</h2>
                <p className="text-brand-blue text-sm mb-4">{plan.description}</p>
              </div>

              <div className="mb-8 flex-grow">
                <h3 className="font-semibold text-brand-maroon mb-3">What's Included:</h3>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-lg p-6 border-2 border-brand-blue min-h-[600px] flex flex-col">
              ...
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-brand-maroon mb-2">{plans[currentPlan].name}</h2>
