      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {successStories.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-2">Sample Success Stories</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
              {[
                { name: 'Rahul Sharma', marks: '95.2%', rank: '3', year: 2024, quote: 'The teachers here made complex topics so easy to understand. Their support was incredible!' },
                { name: 'Priya Patel', marks: '97.8%', rank: '1', year: 2024, quote: 'Best decision I made was joining this academy. The personalized attention helped me excel.' },
                { name: 'Arjun Singh', marks: '94.6%', rank: '5', year: 2023, quote: 'Amazing faculty and excellent study material. Highly recommend to all students!' },
              ].map((story, index) => (
                <div
                  key={index}
                  className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-lg p-6 border border-blue-200 dark:border-blue-800"
